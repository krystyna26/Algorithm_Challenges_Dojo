...
console.log("palindrome 1:", palindrome("gfedcbaabcdefg")); // true
console.log("palindrome 2:", palindrome("mko")); // false
...
console.log("palindrome2 1", palindrome2("gfedcbaabcdefg")); //true
console.log("palindrome2 2", palindrome2("abcba")); // true
